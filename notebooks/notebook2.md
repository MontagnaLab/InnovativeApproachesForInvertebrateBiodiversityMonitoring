...
Now we can use the trained classifier to assign a taxonomic label to each ASV.
```bash
...
```
ℹ️ In real case scenarios, to improve taxonomic classification accuracy you may want to also incorporate environment-specific taxonomic abundance information generated by the [q2-clawback](https://github.com/BenKaehler/q2-clawback) plugin.

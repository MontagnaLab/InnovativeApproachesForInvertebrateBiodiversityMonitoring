...
```
ℹ️ In real case scenarios, to improve taxonomic classification accuracy you may want to use also the `--i-class-weight` parameter to incorporate environment-specific taxonomic abundance information that can be generated by the [q2-clawback](https://github.com/BenKaehler/q2-clawback) plugin.
